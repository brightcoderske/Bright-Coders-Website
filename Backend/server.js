...
import learnerRouter from "./Router/learnerRouter.js";
import lmsAdminRouter from "./Router/lmsAdminRouter.js";
...
app.use("/api/learn", learnerRouter);
app.use("/api/lms-admin", lmsAdminRouter);
